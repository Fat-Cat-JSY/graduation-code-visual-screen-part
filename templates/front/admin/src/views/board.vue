<template>
	<div class="content" :style='{"alignContent":"flex-start","padding":"0 0 53px 0","overflow":"hidden","background":"url(http://codegen.caihongy.cn/20250104/f5f3c3bf499641a9ad7b02fcf340b381.png) no-repeat bottom center,url(http://codegen.caihongy.cn/20250104/74fb86808f734214b656ff6e6baff933.png) no-repeat top center,rgb(3, 12, 59)","flexDirection":"column","display":"flex","width":"100%","position":"relative","height":"100%"}'>
		<div id="particles"></div>
		<div :style='{"padding":"15px 0 0","margin":"0","background":"url(http://codegen.caihongy.cn/20250104/a6f8e90a837b4c2eb8601823d839286f.png) no-repeat top center","display":"flex","width":"100%","position":"relative","justifyContent":"center","height":"98px","zIndex":"2"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0","fontSize":"20px","color":"rgb(255, 255, 255)","textAlign":"center","fontWeight":"700"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"alignItems":"center","top":"0","color":"#fff","display":"flex","lineHeight":"64px","fontSize":"16px","position":"absolute","right":"220px","height":"64px"}'>
				<div :style='{"margin":"0 30px 0 0","fontSize":"16px","whiteSpace":"nowrap","color":"#d0e1f3","display":"inline-block"}'>{{ dates }}</div> 
				<div @click="backClick" :style='{}'>{{frontType==1?'返回':'管理系统'}}</div>
			</div>
		</div>
		<div :style='{"padding":"0","flex":"auto","background":"url(http://codegen.caihongy.cn/20250104/81d376bb600349c6bb9ee3b9e2a3bade.png) no-repeat left center / 180px 100%,url(http://codegen.caihongy.cn/20250104/faebd1e099b7458bb5291b776236cd99.png) no-repeat right center / 170px 100%","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"9"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","display":"flex","gap":"10px"}'>
				<div class="echarts2">
					<div :style='{"padding":"0","margin":"0 0 0 160px","textAlign":"left","background":"none","flex":"none","width":"calc(100% - 160px)","height":"auto"}'>
						<div :style='{"padding":"0 0 0 30px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","fontSize":"20px","lineHeight":"36px","fontWeight":"500"}'>
							销售量统计
						</div>
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery2.title" placeholder="请选择" @change="taobaoinfoChat2" clearable>
							<el-option v-for="item in taobaoinfoChartOptions2" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"width":"100%","padding":"0 0 0 120px","flex":"auto","height":"0"}'>
						<div id="taobaoinfoChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						<div :style='{"padding":"0 0 0 30px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","fontSize":"20px","lineHeight":"36px","fontWeight":"500"}'>
							参数2统计
						</div>
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery5.title" placeholder="请选择" @change="taobaoinfoChat5" clearable>
							<el-option v-for="item in taobaoinfoChartOptions5" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"width":"100%","padding":"0 0 0 40px","flex":"auto","height":"0"}'>
				...
				<div class="echarts6">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						...
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery6.title" placeholder="请选择" @change="taobaoinfoChat6" clearable>
			...
			<div :style='{"width":"50%","padding":"0","flexWrap":"wrap","flexDirection":"row","display":"flex"}'>
				<!-- 统计 -->
				<div :style='{"padding":"0 10px 20px 10px","margin":"0","color":"#fff","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","background":"none","gap":"10px","width":"100%","fontSize":"14px","height":"78px","order":"1"}'>

					<div :style='{"padding":"0 10px","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/9308fb76b74e4fa5be5d28c2f3ad95a4.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1 1 auto","display":"flex","width":"150px","position":"relative","justifyContent":"center","height":"58px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"row","display":"flex","gap":"6px","width":"100%","justifyContent":"space-evenly","height":"100%"}'>
							<div :style='{"color":"inherit","fontSize":"14px","height":"auto"}'>用户总数</div>
							<div :style='{"lineHeight":"44px","fontSize":"16px","color":"rgb(66, 144, 247)","fontWeight":"bold","height":"40px","order":"20"}'>{{yonghuCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0 10px","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/9d069865e5b64db8ab5e104ff7567af0.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1 1 auto","display":"flex","width":"150px","position":"relative","justifyContent":"center","height":"58px","maxWidth":"240px"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"yellow","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"row","display":"flex","gap":"6px","width":"100%","justifyContent":"space-evenly","height":"100%"}'>
							<div :style='{"color":"inherit","fontSize":"14px","height":"auto"}'>淘宝男鞋总数</div>
							<div :style='{"lineHeight":"44px","fontSize":"16px","color":"rgb(212, 107, 8)","fontWeight":"bold","height":"40px","order":"20"}'>{{taobaoinfoCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts8">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="yonghuChart8" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts9">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="yonghuChart9" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts1">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						...
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery1.title" placeholder="请选择" @change="taobaoinfoChat1" clearable>
				...
				<div class="echarts10">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						<div :style='{"padding":"0 0 0 30px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250104/98a6bbd24bd24c75a26b8a0a8f28b0ca.png) no-repeat left center / 278px 36px","fontSize":"18px","lineHeight":"36px","fontWeight":"500"}'>
							淘宝男鞋
						</div>
					</div>
					<el-table id="taobaoinfoTable" :data="taobaoinfoList" border :stripe="false" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"1px 0 0 1px","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="prosheng" label="省">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="procity" label="市">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="title" label="标题">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="imgurl" label="图片">
							<template slot-scope="scope">
								<div v-if="scope.row.imgurl">
									<img v-if="scope.row.imgurl.substring(0,4)=='http'&&scope.row.imgurl.split(',w').length>1" :src="scope.row.imgurl" width="30" height="30">
									<img v-else-if="scope.row.imgurl.substring(0,4)=='http'" :src="scope.row.imgurl.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.imgurl.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jiage" label="价格">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="salesnum" label="销售量">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shoptag" label="标签">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="baoyounew" label="包邮">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="property1" label="参数1">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="property2" label="参数2">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="property3" label="参数3">
						</el-table-column>
					</el-table>
				</div>
				<div class="forecast-box" :style='{"padding":"30px 40px 20px 0px","margin":"0","alignItems":"center","flexDirection":"row","display":"flex","transition":"0.3s","justifyContent":"center","flexWrap":"wrap","background":"none","flex":"0 0 auto","width":"30%","height":"40%","order":"6"}'>
					<div :style='{"width":"100%","margin":"0 0 10px 0","color":"#fff","alignItems":"center","flex":"none","display":"flex"}'>
						<div :style='{"color":"#3f83f8","width":"100px","textAlign":"left"}'>
							省
						</div>
						<input :style='{"border":"1px solid #3f83f8","padding":"0 10px","margin":"0 0 0 10px","color":"#3f83f8","background":"none","width":"calc(100% - 100px)","lineHeight":"30px","height":"30px"}' v-model="forecastForm.prosheng" placeholder="请输入省"></input>
					</div>
					<div :style='{"width":"100%","margin":"0 0 10px 0","color":"#fff","alignItems":"center","flex":"none","display":"flex"}'>
						<div :style='{"color":"#3f83f8","width":"100px","textAlign":"left"}'>
							标题
						</div>
						<input :style='{"border":"1px solid #3f83f8","padding":"0 10px","margin":"0 0 0 10px","color":"#3f83f8","background":"none","width":"calc(100% - 100px)","lineHeight":"30px","height":"30px"}' v-model="forecastForm.title" placeholder="请输入标题"></input>
					</div>
					<div :style='{"width":"100%","margin":"0 0 10px 0","color":"#fff","alignItems":"center","flex":"none","display":"flex"}'>
						<div :style='{"color":"#3f83f8","width":"100px","textAlign":"left"}'>
							销售量
						</div>
						<input :style='{"border":"1px solid #3f83f8","padding":"0 10px","margin":"0 0 0 10px","color":"#3f83f8","background":"none","width":"calc(100% - 100px)","lineHeight":"30px","height":"30px"}' v-model="forecastForm.salesnum" placeholder="请输入销售量"></input>
					</div>
					<div :style='{"width":"100%","margin":"0 0 10px 0","color":"#fff","alignItems":"center","flex":"none","display":"flex"}'>
						<div :style='{"color":"#3f83f8","width":"100px","textAlign":"left"}'>
							价格
						</div>
						<input :style='{"border":"1px solid #3f83f8","padding":"0 10px","margin":"0 0 0 10px","color":"#3f83f8","background":"none","width":"calc(100% - 100px)","lineHeight":"30px","height":"30px"}' v-model="forecastForm.jiage" placeholder="请输入价格"></input>
					</div>
					<div :style='{"width":"100%","fontSize":"16px","lineHeight":"40px","color":"#3f83f8","textAlign":"center"}'>
						预测标签：{{form.shoptag}}
					</div>
					<div @click="forecastClick" :style='{"border":"1px solid #3f83f8","cursor":"pointer","margin":"0","color":"#3f83f8","borderRadius":"5px","textAlign":"center","background":"none","width":"120px","lineHeight":"34px","height":"34px"}'>
						立即预测
					</div>
				</div>
			</div>
				...
				<div class="echarts3">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						...
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery3.title" placeholder="请选择" @change="taobaoinfoChat3" clearable>
							<el-option v-for="item in taobaoinfoChartOptions3" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"width":"100%","padding":"0 80px 0 0","flex":"auto","height":"0"}'>
				...
				<div class="echarts4">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						...
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery4.title" placeholder="请选择" @change="taobaoinfoChat4" clearable>
							<el-option v-for="item in taobaoinfoChartOptions4" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"width":"100%","padding":"0 75px 0 0","flex":"auto","height":"0"}'>
				...
				<div class="echarts7">
					<div :style='{"padding":"0","margin":"0","textAlign":"left","background":"none","flex":"none","width":"100%","height":"auto"}'>
						...
						<el-select
							v-if="changeStatQuery(['users'])"
							class="querySelect"
							v-model="taobaoinfochartQuery7.title" placeholder="请选择" @change="taobaoinfoChat7" clearable>
							<el-option v-for="item in taobaoinfoChartOptions7" :label="item" :value="item"></el-option>
						</el-select>
					</div>
					<div :style='{"width":"100%","padding":"0 110px 0 0","flex":"auto","height":"0"}'>
	...
	export default {
		data() {
			return {
				...
				gauge: {"tooltip":{"formatter":"{b} : {c}","trigger":"item"},"backgroundColor":"transparent","color":["#3f83f8","#fada58","#e49207","#73D13D","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"title":{"show":false,"textStyle":{"textBorderWidth":0,"color":"#ccc","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"top":"top","left":"left"},"series":{"pointer":{"offsetCenter":[0,"10%"],"icon":"path://M2.9,0.7L2.9,0.7c1.4,0,2.6,1.2,2.6,2.6v115c0,1.4-1.2,2.6-2.6,2.6l0,0c-1.4,0-2.6-1.2-2.6-2.6V3.3C0.3,1.9,1.4,0.7,2.9,0.7z","width":8,"length":"80%"},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"opacity":0.5,"shadowBlur":1,"shadowColor":"#000"},"roundCap":true},"anchor":{"show":true,"itemStyle":{"color":"inherit"},"size":18,"showAbove":true},"emphasis":{"disabled":false},"progress":{"show":true,"roundCap":true,"overlap":true},"splitNumber":10,"detail":{"formatter":"{value}","backgroundColor":"inherit","color":"#fff","borderRadius":3,"width":20,"fontSize":12,"height":12},"title":{"color":"#ccc","fontSize":12},"animation":true}},
				radar: {"backgroundColor":"transparent","radar":{"splitLine":{"lineStyle":{"color":"rgba(255, 255, 255, 0.1)"}},"name":{"textStyle":{"color":"#ddd","fontSize":13,"fontWeight":"bold"}},"shape":"circle","axisLine":{"lineStyle":{"color":"rgba(255, 255, 255, 0.2)"}},"splitArea":{"areaStyle":{"color":["rgba(0, 0, 0, 0.1)","rgba(20, 20, 20, 0.1)"],"opacity":1}}},"color":["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"legend":{"shadowOffsetX":0,"borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"itemHeight":14,"show":true,"icon":"roundRect","type":"scroll","top":"auto","lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"borderWidth":0,"itemWidth":25,"shadowColor":"rgba(0,0,0,.3)","height":"auto","padding":5,"itemGap":10,"backgroundColor":"transparent","orient":"horizontal","bottom":"auto","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","borderRadius":0,"left":"right","width":"auto","textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0}},"series":{},"tooltip":{"backgroundColor":"#123","textStyle":{"color":"#fff"}},"title":{"top":"bottom","show":false,"left":"left"}},
				myChart0: null,
				taobaoinfoList: [],
				taobaoinfoTimer: null,
				dates: '',
				yonghuCount: 0,
				taobaoinfoCount: 0,
				forecastForm: {},
				form: {},
				particlesJson: {"retina_detect":true,"particles":{"number":{"density":{"value_area":800,"enable":true},"value":6},"move":{"straight":true,"random":true,"bounce":false,"enable":true,"attract":{"rotateX":600,"enable":false,"rotateY":600},"speed":6,"direction":"bottom","out_mode":"out"},"color":{"value":"#fff"},"shape":{"image":{"width":20,"src":"http://codegen.caihongy.cn/20241115/e750ff1907a2423bb12d1c4fb49310dd.png","height":20},"polygon":{"nb_sides":5},"type":"image","stroke":{"color":"#000000","width":0}},"size":{"anim":{"size_min":0.1,"sync":false,"enable":false,"speed":40},"random":true,"value":10},"line_linked":{"width":1,"distance":150,"color":"#ffffff","opacity":0.4,"enable":false},"opacity":{"anim":{"opacity_min":0,"sync":false,"enable":false,"speed":30},"random":true,"value":0.5}},"interactivity":{"detect_on":"canvas","events":{"resize":true,"onclick":{"mode":"push","enable":false},"onhover":{"mode":"grab","enable":false}},"modes":{"grab":{"distance":400,"line_linked":{"opacity":1}},"bubble":{"duration":2,"distance":250,"size":0,"opacity":0,"speed":3},"repulse":{"duration":0.4,"distance":400},"push":{"particles_nb":4},"remove":{"particles_nb":2}}}},
				frontType: 0,
				yonghuchartQuery8: {},
				yonghuChartOptions8: [],
				yonghuchartQuery9: {},
		...
		methods:{
						...
						if(res.data&&res.data.code==0){
							...
							this.$http({
								...
								if(obj.data&&obj.data.code==0){
									this.$http({
										url: 'taobaoinfoforecast/info/' + res.data.data,
										method: 'get'
									}).then(rs2=>{
			...
			gettaobaoinfoList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.taobaoinfoList = data.data.list;
						let div = document.getElementById('taobaoinfoTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.taobaoinfoTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.taobaoinfoTimer);
						})
			...
			yonghuChat8(e=null) {
				this.$nextTick(()=>{
					...
					var yonghuChart8 = echarts.init(document.getElementById("yonghuChart8"),'macarons');
					let params = {
						order: 'desc',
					}
					this.$http({
			...
			yonghuChat9(e=null) {
				this.$nextTick(()=>{
					...
					var yonghuChart9 = echarts.init(document.getElementById("yonghuChart9"),'macarons');
					let params = {
					}
					this.$http({
				...
				this.$nextTick(()=>{
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							this.myChartInterval(2, option.yAxis.data, option.series[0].data, taobaoinfoChart2)
				...
				this.$nextTick(()=>{
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							this.myChartInterval(1, option.xAxis.data, option.series[0].data, taobaoinfoChart1)
